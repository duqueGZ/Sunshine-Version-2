...
public class MainActivity extends ActionBarActivity implements ForecastFragment.Callback {
     ...
     */
    static final String PROJECT_NUMBER = "652430342769";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forecastFragment.setUseTodaySpecialLayout(!mTwoPane);
        ...
        if (checkPlayServices()) {
            ...
            if (PROJECT_NUMBER.equals("Your Project Number")) {
                ...
                Log.i(LOG_TAG, "Going to register GCM in background");
    ...
    private void registerInBackground(final Context context) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                Log.i(LOG_TAG, "registerInBackground doInBackground");
                String msg = "";
                try {
                    if (mGcm == null) {
                    ...
                    Log.e(LOG_TAG, "registerInBackground ERROR: " + msg);
                }
                return null;
            }
