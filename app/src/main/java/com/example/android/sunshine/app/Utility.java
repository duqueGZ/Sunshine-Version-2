...
public class Utility {
    ...
    private static int getWindDirectionResourceId(float degrees) {
        int id = -1;
        if (degrees >= 337.5 || degrees < 22.5) {
            id = R.string.windDirectionN;
        } else if (degrees >= 22.5 && degrees < 67.5) {
            id = R.string.windDirectionNE;
        } else if (degrees >= 67.5 && degrees < 112.5) {
            id = R.string.windDirectionE;
        } else if (degrees >= 112.5 && degrees < 157.5) {
            id = R.string.windDirectionSE;
        } else if (degrees >= 157.5 && degrees < 202.5) {
            id = R.string.windDirectionS;
        } else if (degrees >= 202.5 && degrees < 247.5) {
            id = R.string.windDirectionSW;
        } else if (degrees >= 247.5 && degrees < 292.5) {
            id = R.string.windDirectionW;
        } else if (degrees >= 292.5 && degrees < 337.5) {
            id = R.string.windDirectionNW;
        }
        return id;
    }
    ...
    public static String getWindAccesibleContentDescription(Context context, float windSpeed,
                                                            float degrees) {
        int windFormat;
        if (Utility.isMetric(context)) {
            windFormat = R.string.format_wind_kmh_accesibility;
        } else {
            windFormat = R.string.format_wind_mph_accesibility;
        }
        String contentDescription = context.getString(R.string.wind) + ": " +
                String.format(context.getString(windFormat), windSpeed) +
                context.getString(Utility.getWindDirectionResourceId(degrees));

        return contentDescription;
    }

    public static String getWindDirectionAccesibleContentDescription(Context context,
                                                                     float degrees) {

        String contentDescription = context.getString(R.string.wind_orientation) + " " +
                degrees + context.getString(R.string.degrees);
